 ...
 */
package io.igia.i2b2.cdi.derivedfact.processor;
...
public class DerivedFactProcessor implements ItemProcessor<ObservationFact, ObservationFact> {
	...
	@Override
	public ObservationFact process(ObservationFact item) throws Exception {
