...
@Component
public class I2b2DerivedConceptDefinitionRowMapper implements RowMapper<DerivedConceptDefinition> {
	...
	public DerivedConceptDefinition mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		derivedConceptDefinition.setConceptCode(rs.getString("concept_cd"));
