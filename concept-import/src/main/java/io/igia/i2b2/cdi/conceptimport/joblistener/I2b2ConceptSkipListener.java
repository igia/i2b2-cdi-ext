...
@Component
public class I2b2ConceptSkipListener implements SkipListener<CsvConcept, CsvConcept> {

	private static final Logger log = LoggerFactory.getLogger(I2b2ConceptSkipListener.class);
	private FlatFileItemWriter<CsvConcept> flatFileItemWriter;
	private static final String DUPLICATE_RECORD = "Duplicate Record";

	public I2b2ConceptSkipListener (FlatFileItemWriter<CsvConcept> writer) {
