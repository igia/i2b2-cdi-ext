...
public class FileMessageToJobRequestConcept {
	...
	public JobLaunchRequest toRequest(Message<ArrayList<Object>> message) {
		...
		FileHelper.createMissingFiles(properties.getLocalDataDirectoryPath(), ConceptFileName.getConceptFileMap());
		...
		jobLaunchRequest = new JobLaunchRequest(importConceptJob, jobParametersBuilder.toJobParameters());
