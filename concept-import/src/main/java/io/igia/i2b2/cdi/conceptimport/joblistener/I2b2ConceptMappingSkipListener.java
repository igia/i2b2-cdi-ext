...
@Component
public class I2b2ConceptMappingSkipListener implements SkipListener<CsvConceptMapping, CsvConceptMapping> {

	private static final Logger log = LoggerFactory.getLogger(I2b2ConceptMappingSkipListener.class);
	...
	public I2b2ConceptMappingSkipListener (FlatFileItemWriter<CsvConceptMapping> writer) {
