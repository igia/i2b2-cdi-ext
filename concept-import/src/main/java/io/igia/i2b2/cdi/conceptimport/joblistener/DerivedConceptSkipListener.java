...
@Component
public class DerivedConceptSkipListener implements SkipListener<DerivedConceptDefinition, DerivedConceptDefinition> {

	private static final Logger log = LoggerFactory.getLogger(DerivedConceptSkipListener.class);
	private FlatFileItemWriter<DerivedConceptDefinition> flatFileItemWriter;

	public DerivedConceptSkipListener (FlatFileItemWriter<DerivedConceptDefinition> writer) {
