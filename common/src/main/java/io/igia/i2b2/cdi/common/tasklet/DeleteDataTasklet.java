...
public class DeleteDataTasklet implements Tasklet {
	...
	public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
		...
		jdbcTemplate.update(DeleteDataQueries.DEMOGRAPHICS.getQuery());
		jdbcTemplate.update(DeleteDataQueries.ENCOUNTERS.getQuery());
		jdbcTemplate.update(DeleteDataQueries.PROVIDER_REFERENCES.getQuery());
		jdbcTemplate.update(DeleteDataQueries.OBSERVATION_FACTS.getQuery());
