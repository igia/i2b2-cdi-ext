...
@Component
public class I2b2ProviderSkipListener implements SkipListener<CsvProviderReference, CsvProviderReference> {

	private static final Logger log = LoggerFactory.getLogger(I2b2ProviderSkipListener.class);
	...
	public I2b2ProviderSkipListener (FlatFileItemWriter<CsvProviderReference> writer) {
