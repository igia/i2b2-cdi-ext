...
@Component
public class I2b2ObservationFactSkipListener implements SkipListener<CsvObservationFact, CsvObservationFact> {

	private static final Logger log = LoggerFactory.getLogger(I2b2ObservationFactSkipListener.class);
	...
	public I2b2ObservationFactSkipListener (FlatFileItemWriter<CsvObservationFact> writer) {
